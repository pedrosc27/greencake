...
function getAllUrlParams(url) {
  ...
  function guardarProducto() {    
    var win = window.open(`https://wa.me/5213318800376?text=Hola,+estoy+interesado+en+el+Pastel+:+*${nombreWhats}*+,+Tamaño+:+${tamano.value}+,+Bizcocho+:+${bizcocho.value}+,+Relleno+:+${relleno.value}+`, '_blank');
